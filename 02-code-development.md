...
> Curated free developer tools and services for Code & Development: Source Code Repos, Code Generation, Code Quality, Code Search and Browsing, CI and CD, Low-code Platform, Package Build System, IDE and Code Editing
...
-   [outsystems.com](https://www.outsystems.com/ "Provides a low-code PaaS for building web applications, offering a free \"personal environment\" with unlimited code and up to 1 GB of database storage. This free tier is ideal for individual developers or small teams prototyping applications, but lacks custom domain support. It serves as a free entry point for those evaluating enterprise-grade low-code platforms, potentially replacing manual coding for internal tools.") - Enterprise web development PaaS for on-premise or cloud, free "personal environment" offering allows for unlimited code and up to 1 GB database
